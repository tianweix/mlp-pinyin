...
describe('useProgress', () => {
  ...
  it('loads saved progress from localStorage', () => {
    ...
    localStorage.setItem('pinyin-progress', JSON.stringify(saved));
  ...
  it('handles invalid JSON in localStorage gracefully', () => {
    localStorage.setItem('pinyin-progress', 'not-json');
  ...
  it('handles localStorage with missing stars field', () => {
    localStorage.setItem('pinyin-progress', JSON.stringify({ foo: 'bar' }));
  ...
  it('persists progress to localStorage', () => {
    ...
    const stored = JSON.parse(localStorage.getItem('pinyin-progress'));
